...
// watch(props.save, async (dt) => {
//     console.log(dt);
// }, {flush: 'post'})

// const prop = watchEffect(props.save, async (dt) => {
...
async function filepondInitialized(file, output) {
    ...
    //       source: "https://i.imgur.com/biNJ06H.jpg",
    ...
    //         file: {
    //           name: "https://i.imgur.com/biNJ06H.jpg",
    //           size: img.size,
    //           type: img.mime_type,
    //         },

    //         metadata: {
    //           poster: "https://i.imgur.com/biNJ06H.jpg",
    //         },
    //       },
    //     },
    //   ],
