                            ...
                            <div class="grid gap-4" :class="el.name" v-if="el.cols.length">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <component :is="col.field" @change="changeData($event, col.field, el, a, el.cols[index], index)" @input="getData($event, col.field, el, a, el.cols[index], index)" :name="col.field" class="px-4 py-3 rounded-lg" :formId="f.id"> </component>
...
export default {
    ...
    methods: {
        ...
        changeData(e, dataType, row, i, col, o) {
            console.log(dataType);
            console.log(e);
