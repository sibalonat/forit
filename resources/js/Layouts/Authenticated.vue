                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <BreezeNavLink :href="route('app.pinia')" :active="route().current('app.pinia')">
                                    Pinia
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('app.tours')" :active="route().current('app.tours')">
                                    Virtual Tours
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('users.all')" :active="route().current('users.all')">
                                    Users
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('layout.mixin')" :active="route().current('layout.mixin')">
                                    Layout
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('layout.pamixin')" :active="route().current('layout.pamixin')">
                                    Layout pa Mixin
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('app.mind')" :active="route().current('app.mind')">
                                    Mind
                                </BreezeNavLink>
                                <BreezeNavLink :href="route('project.all')" :active="route().current('project.all')">
                                    Project
                                </BreezeNavLink>
                            </div>
                        </div>
